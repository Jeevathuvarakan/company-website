                                ...
                                <div className="flex flex-col gap-[18px] ">
                                    ...
                                    <div className="">
                                        ...
                                        <input
                                            type="subject"
                                            name="subject"
                                            className="w-full h-[50px]  p-[15px] text-sm bg-[#fff] text-[#333]"
                                    ...
                                    <div className="">
                                        <button className=" text-[16px] text-white  px-[24px] py-[12px] w-full bg-[#0067ff] rounded-[4px] font-medium  hover:bg-[#2c2ea8] ">
                                            SUBMIT NOW
                                        </button>
                                    </div>
                                </div>
